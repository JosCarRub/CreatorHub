# Generated by Django 5.1.3 on 2025-02-16 17:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puntuacion_promedio', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado_aplicacion', models.CharField(choices=[('aceptada', 'Aceptada'), ('denegada', 'Denegada'), ('solicitada', 'Solicitada')], default='solicitada', max_length=100, verbose_name='Estado de la aplicación a la oferta')),
