# Generated by Django 5.1.3 on 2025-02-09 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redes_sociales', models.ManyToManyField(related_name='get_oferta_redes', to='aplicacion.redessocialesoferta')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='OfertaRedesSociales',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('oferta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aplicacion.oferta')),
                ('redes_sociales', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aplicacion.redessocialesoferta')),
            ],
            options={
                'unique_together': {('oferta', 'redes_sociales')},
            },
        ),
    ]
