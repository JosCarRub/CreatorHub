# Generated by Django 5.1.3 on 2025-01-19 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otras_rrss', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plataformas', models.CharField(choices=[('tiktok', 'TikTok'), ('instagram', 'Instagram'), ('facebook', 'Facebook'), ('otra', 'Otra')], max_length=50)),
                ('otra_plataforma', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aplicacionesOferta', to=settings.AUTH_USER_MODEL)),
                ('oferta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aplicaciones', to='aplicacion.oferta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oferta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tiposDeOferta', to='aplicacion.oferta')),
            ],
            options={
